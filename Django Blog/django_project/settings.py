...
SECRET_KEY = 'django-insecure-)+enqls%no55jcnq6_sb5=_2+1+cl=ms-c^($b8xyxn=ctdx3+'
...
INSTALLED_APPS = [
    'blog.apps.BlogConfig', #Add application here from blog.apps
    'users.apps.UsersConfig',
    'crispy_forms', # For styling our registration form
